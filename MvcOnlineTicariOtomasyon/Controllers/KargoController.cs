...
namespace MvcOnlineTicariOtomasyon.Controllers
{
    ...
    public class KargoController : Controller
    {
        ...
        // **** SADECE KARGO KODUYLA ARAMA YAPMAK İÇİN ****
        ...
        {
            //10 karakterli bir takip kodu oluşturacağız.
            //10 --> 3 1 2 1 2 1
        ...
        public ActionResult KargoEkle(KargoDetay k)
        {
            ...
            c.KargoDetays.Add(k); //Context(c)'te bulununan Departmans'a ekle d değerini.
            c.SaveChanges(); //Bu değerleri veritabanına kaydet.
            return RedirectToAction("Index");
        }

        //********************************* KARGO TAKİP ******************************
        public ActionResult KargoTakip(string id) //Sayfalar arası geçiş olacaksa veriyi id olarak göndermek zorundasın. Çünkü RouteConfig'de id olarak belirtilmiş.
        {
